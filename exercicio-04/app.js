...
*/
const my3FavoriteTVShows = ['Breaking Bad', 'Spider Man', 'Iron Man']

const sentence = `Minhas 3 séries favoritas são: ${my3FavoriteTVShows.join(', ').replace(', I', ' e I')}`
...
// caracteres?  ${typeSentence.length > 39}`)
