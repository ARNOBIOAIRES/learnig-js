...
for (let i = 0; i < randomNumbers.length; i++) {
    ...
    sumResult += randomNumbers[i] */
     /* 
     aprendi aqui, que a interação do for foi executada depois do codigo do if onde tem um break
     */
...
/*   }
 ...
 //dica importante 'o espaço' dentro da templante string para separar as palavras
...
console.log(`3 informações sobre o array randomValues:
    - As primeiras 4 strings são ${firstFourStrings.join(', ')};
...
//objetivo: somar os itens de todos os arrys
...
for (let i = 0; i < arrys.length; i++) { //esssa linha percorre o tamanho do array
