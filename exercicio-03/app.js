...
brazilianFoods.push('Cozinha', 'null', 'Brigadeiro')
...
console.log(brazilianFoods[1] = 'Pao de Queijo')
...
array "brazilianFoods" possui ${brazilianFoods.length} itens: ${brazilianFoods.join(', ').replace(', B' , ' e B')} `
...
const dessert = `A ${dogNames[0].slice(3, 5)}${dogNames[1].slice(2, 5)}${dogNames[3].slice(2, 5).replace('na', 'da')} é um doce à base de coco, tradicional na América Latina e em Angola.`
console.log(dessert)
