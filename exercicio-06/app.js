...
const fruits = ['morango', 'banana', 'pera', 'mamão']
/* 
...
if (hours > 6 && hours < 12) {
  ...
  console.log("Priscila vai estudar power bi BOA TARDE")
...
let priceMensage = null

if (age < 7 || age > 65) {
  priceMesage = 'Para você, a entrada é grátis'
} else {
  priceMensage = 'A entrada é R$ 30,00.'
}
console.log(priceMensage)
...
for (let i = 0; i < crazyArray.length; i++) {
  ...
  console.log(`O crazyArray tem ${numberAmount} numbers,  ${booleanAmount} booleans e ${stringAmount} strings.   `)
